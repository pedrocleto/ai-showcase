...
describe('OverviewComponent', () => {
  ...
  const mockCompareService = jasmine.createSpyObj('CompareService', [
    'getAllAgents',
    'searchAgentByName',
    'getAgentById',
  ]);
  mockCompareService.getAllAgents.and.returnValue(
    of([
      {
        id: 1,
        name: 'IMPALA',
  ...
  beforeEach(
    waitForAsync(() => {
      TestBed.configureTestingModule({
        ...
        providers: [{ provide: CompareService, useValue: mockCompareService }],
      }).compileComponents();
    })
  );
